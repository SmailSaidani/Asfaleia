      ...
      <IconContext.Provider value={{ color: '#fff' }}>
        ...
        <SidebarNav sidebar={sidebar}>
          <SidebarWrap>
            ...
            <Link className='navbar' onClick={() => window.location.href="/expert"}> <Dvr className='iconnv'/> <div className='textN'>Dashboard</div></Link>
            

            <Link className='navbar' onClick={() => window.location.href="/Setting"}> <Settings className='iconnv'/> <div className='textN'>Setting</div></Link>


            <Link className='navbar' onClick={dec} > <AiIcons.AiOutlineLogout className='iconnv' />  <div className='textN'>Deconnecter</div> </Link>
            
                        
            {/* <div className='decB' onClick={dec}><SubMenu  item={ite3} /></div> */}
